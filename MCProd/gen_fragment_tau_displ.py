...
leptonFilter = cms.EDFilter("MCMultiParticleFilter",
    ...
    PtMin = cms.vdouble(20.),
    EtaMax = cms.vdouble(999.),
    Status = cms.vint32(0), # 0: any status
    MinDecayRadius = cms.untracked.vdouble(10.), # in mm
    MaxDecayRadius = cms.untracked.vdouble(1000.), # in mm
    MinDecayZ = cms.untracked.vdouble(-12000.), # in mm
    MaxDecayZ = cms.untracked.vdouble(12000.), # in mm
)
